    ...
    <div className="mc-warm" style={{ background: "#F4EFE6", color: "#1F1B16" }} data-screen-label="Landing público">
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
            {[
              ...
              { icon: "rocket", title: "Acceso anticipado", body: "Pruebas cada feature antes que cualquier otro miembro." },
      ...
      <section style={{ maxWidth: 1240, margin: "0 auto", padding: "64px 32px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {[
            { n: "01", t: "Súmate al Club", d: "Toma 30 segundos para registrarte. Si eres de los primeros 100, eres Fundador y tienes beneficios permanentes." },
            { n: "02", t: "Publica tu vehículo", d: "Hasta 20 fotos + 1 video. Autocompletamos marca y modelo. Contacto directo por WhatsApp." },
            { n: "03", t: "Vende al mejor postor", d: "Compradores te contactan, tú acuerdas precio y método. Motorra no toma comisión." },
          ].map(s => (
