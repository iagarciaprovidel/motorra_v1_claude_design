        ...
        <div style={{ background: "#1F1B16", color: "#F4EFE6", padding: "32px 36px 28px", position: "relative" }}>
          ...
          {step === 2 && (<>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.55, marginTop: 12, color: "rgba(244,239,230,0.75)" }}>
              Reservaste el lugar #{founderNum}. Decinos un poco más sobre vos.
            </p>
          </>)}
          ...
          {step === 3 && (<>
            ...
            <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 30, letterSpacing: "-0.02em", margin: 0, color: "#F4EFE6" }}>
              Sos Fundador Motorra #{founderNum}.
            </h2>
            <p style={{ fontSize: 13, lineHeight: 1.55, marginTop: 12, color: "rgba(244,239,230,0.75)" }}>
        ...
        <div style={{ padding: "26px 36px 28px" }}>
          {step === 1 && (<>
            <div style={{ marginBottom: 24 }}>
              {[
                ...
                { e: "💰", t: "0% comisión para siempre", d: "Cuando empecemos a cobrar, vos no" },
                { e: "🚀", t: "Acceso anticipado a features", d: "Probás todo antes que cualquier otro" },
            ...
            <div style={{ fontSize: 11, color: "#8B7E66", textAlign: "center", marginTop: 12, lineHeight: 1.45 }}>
              Al continuar aceptás los <span style={{ textDecoration: "underline" }}>términos</span> y la <span style={{ textDecoration: "underline" }}>privacidad</span> de Motorra.
            </div>
          </>)}

          {step === 2 && (<>
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <Input label="Nombre y apellido" placeholder="Cómo querés aparecer en el club" value={data.name} onChange={e => setData({...data, name: e.target.value})}/>
          ...
          {step === 3 && (<>
            ...
            <p style={{ fontSize: 13, color: "#5A4F3C", lineHeight: 1.55, margin: "0 0 18px" }}>
              Lo siguiente: publicá tu vehículo o explorá lo que tus 47 colegas fundadores están ofreciendo.
            </p>
