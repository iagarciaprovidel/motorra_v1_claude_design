        ...
        {step === 1 && (
          <div style={{ background: "#272A3E", borderRadius: 14, padding: 28 }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 26, letterSpacing: "-0.02em", margin: "0 0 6px", color: "#F3F4F6" }}>
              Empezá por la patente.
            </h2>
            <p style={{ fontSize: 13, color: "#9CA3AF", margin: "0 0 22px", lineHeight: 1.55 }}>
              Con tu patente o VIN traemos marca, modelo, año y especificaciones automáticamente. Si preferís, completalo a mano.
            </p>
        ...
        {step === 2 && (
          <div style={{ background: "#272A3E", borderRadius: 14, padding: 28 }}>
            ...
            <div>
              ...
              <textarea placeholder="Contales por qué vendés, qué le agregaste, qué le falta. Honestidad vende." rows={4} style={{
