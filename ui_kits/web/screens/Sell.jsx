    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginTop: 24 }}>
      <div style={{ background: "var(--bg-canvas)", border: "1px solid var(--border)", borderRadius: 16, padding: 24 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          ...
          <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 19, margin: 0 }}>Aceptás esta oferta</h3>
        </div>
      ...
      <div style={{ background: "var(--bg-canvas)", border: "1px solid var(--border)", borderRadius: 16, padding: 24 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
          ...
          <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 19, margin: 0 }}>Querés probar el mercado</h3>
        </div>
        <p style={{ fontSize: 13, color: "var(--fg-muted)", lineHeight: 1.55, margin: "0 0 16px" }}>
