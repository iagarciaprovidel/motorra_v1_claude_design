      ...
      <section style={{ padding: "72px 0" }}>
        <Container>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
            {[
              { n: "01", title: "Cargá tu auto", body: "Patente o VIN y precargamos los datos. Subís 4 fotos y describís el estado. 3 minutos." },
              { n: "02", title: "Lo publicamos gratis", body: "Aparece en Motorra al instante. Sin destacar pagos, sin comisión, sin letra chica." },
              { n: "03", title: "Vendés y cobrás", body: "Te conectamos con compradores. Cerrás el trato y te pagamos. O lo hacés directo, vos elegís." },
            ].map(s => (
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 32, flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <p style={{ fontSize: 14, color: "var(--fg-muted)", marginTop: 8, maxWidth: 480 }}>
                Arrancamos con publicación y venta. Sumate a la lista de espera y te avisamos apenas activemos cada feature.
              </p>
            </div>
          </div>
            ...
            {[
              ...
              onMouseLeave={e => { e.currentTarget.style.borderColor = "var(--border)"; e.currentTarget.style.transform = "translateY(0)"; }}>
                ...
                <div style={{ fontSize: 12, color: "var(--coral-600)", fontWeight: 600, display: "inline-flex", alignItems: "center", gap: 4 }}>
                  Avisame cuando esté <Icon name="arrow-right" size={13} />
                </div>
              </button>
            ))}
          </div>
      ...
      <section style={{ padding: "80px 0" }}>
        <Container>
          <div style={{
            ...
            <div>
              <div style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "rgba(14,16,21,0.6)", marginBottom: 16 }}>Vendé tu auto · sin comisión</div>
              ...
              <p style={{ fontSize: 17, lineHeight: 1.5, marginTop: 20, maxWidth: 480, color: "rgba(14,16,21,0.78)" }}>
                Patente, año, fotos. Te damos una oferta cash al instante — o publicalo al precio que quieras, sin pagarnos nada. Vos elegís.
              </p>
      ...
      <section style={{ padding: "0 0 88px" }}>
        <Container max={880}>
          ...
          {[
            ...
            { q: "¿Qué tipo de vehículos puedo vender?", a: "Cualquier vehículo motorizado: autos, motos, camionetas (pickups), SUV, vehículos eléctricos e híbridos, vans, camiones livianos y comerciales. Si tiene patente chilena al día, lo podés publicar." },
            ...
            { q: "¿Puedo comprar un vehículo en Motorra?", a: "Sí. Podés explorar todo el inventario en la sección Comprar o navegar por categorías. El contacto con el vendedor es directo — hoy por WhatsApp o mensaje interno. Próximamente sumamos inspección certificada de 240 puntos (Q3 2026), historial VIN verificado (Q4 2026) y financiamiento integrado (2027)." },
            { q: "¿Inspeccionan los vehículos?", a: "La inspección de 240 puntos llega junto con el módulo de compra (Q3 2026). Por ahora, las ventas que se cierran a través de Motorra son particular-a-particular: vos ponés el precio, los compradores te contactan." },
            { q: "¿Cómo se cobra el pago de la venta?", a: "Vos y el comprador acuerdan el método de pago — Motorra todavía no procesa pagos. Te damos las herramientas para hacer la transacción segura (verificación de identidad, plantilla de transferencia, checklist de cierre). En 2027 lanzamos pago integrado en plataforma." },
          ].map((item, i) => (
            <details key={i} style={{
