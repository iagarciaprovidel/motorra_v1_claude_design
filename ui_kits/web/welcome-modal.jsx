      ...
      >
        ...
        <div style={{ padding: "24px 32px 28px" }}>
          ...
          <p style={{ fontSize: 14, color: "var(--fg-muted)", lineHeight: 1.55, margin: "0 0 20px" }}>
            Sin comisiones, sin destacados pagos, sin letra chica. Mientras crecemos en comunidad, vos crecés con nosotros.
          </p>

          <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 22 }}>
            {[
              { icon: "tag", title: "0% comisión al vender", body: "Publicá ilimitado, recibí contactos, cerrá fuera de la plataforma — sin pagarnos nada." },
              { icon: "shield-check", title: "Inspección y garantía opcionales", body: "Si querés certificar tu auto, lo hacemos. Si no, igual lo publicás." },
          ...
          <div style={{ fontSize: 11, color: "var(--fg-subtle)", textAlign: "center", marginTop: 14, lineHeight: 1.5 }}>
            Al continuar, aceptás nuestros <span style={{ color: "var(--fg-muted)", textDecoration: "underline" }}>Términos</span> y <span style={{ color: "var(--fg-muted)", textDecoration: "underline" }}>Política de privacidad</span>.
          </div>
        </div>
      </div>
    </div>
