      ...
      <div style={{
        ...
        <div style={{ background: "var(--bg-dark)", color: "var(--paper)", padding: "32px 36px 28px", position: "relative" }}>
          ...
          <p style={{ fontSize: 14, lineHeight: 1.55, marginTop: 14, color: "rgba(250,247,240,0.78)", maxWidth: 420 }}>
            Somos el marketplace especializado en <strong style={{ color: "var(--paper)", fontWeight: 700 }}>compra y venta de vehículos motorizados</strong> en Chile. Por ahora puedes publicar tu auto, moto o camioneta y venderla sin pagarnos nada — sin comisiones, sin destacados pagos, sin letra chica.
          </p>
        </div>

        {/* Roadmap list */}
        <div style={{ padding: "24px 36px 28px" }}>
          <div style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--fg-muted)", marginBottom: 14 }}>Qué puedes hacer hoy</div>
    ...
    <div style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        <p style={{ fontSize: 14, color: "var(--fg-muted)", lineHeight: 1.55, marginTop: 8, marginBottom: 22 }}>
          Estamos arrancando con publicación y venta de vehículos en Chile. {feature} es parte del roadmap — deja tu email y te avisamos apenas esté disponible.
        </p>
